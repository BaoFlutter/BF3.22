...
class _StudentAdjustmentScreenState extends State<StudentAdjustmentScreen> {
            ...
            children: [
              ...
              CustomButton(
                  onPressed: (){
                    ...
                    Information information = Information(id: null, average_score: averageMark, adjustment: adjustment);
                    saveInformationIntoDatabase(information);
                  },
  ...
  saveInformationIntoDatabase(Information information)async{
